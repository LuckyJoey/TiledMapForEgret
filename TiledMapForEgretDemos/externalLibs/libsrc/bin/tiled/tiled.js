...
(function (tiled) {
    var TMXTilemap = (function (_super) {
         ...
         * @version egret 3.0.3
         */
        function TMXTilemap(renderRectX,renderRectY,renderwidth, renderheight, data, url) {
            var _this = _super.call(this) || this;
            _this._tmxRenderer = null;
            _this._data = data;
            _this._renderWidth = renderwidth;
            _this._renderHeight = renderheight;
            _this.renderRectX=renderRectX;
            _this.renderRectY=renderRectY;
        ...
        TMXTilemap.prototype.parseLayer = function (data, z) {
            ...
            var onAllImageLoad = function (event) {
                ...
                this.draw(new egret.Rectangle(self.renderRectX, self.renderRectY, self._renderWidth, self._renderHeight));//mwt
            };
...
(function (tiled) {
    var TMXOrthogonalRenderer = (function (_super) {
        ...
        TMXOrthogonalRenderer.prototype.drawTileLayer = function (layer, rect) {
            ...
            var start = this.pixelToTileCoords(rect.x,rect.y);//mwt
