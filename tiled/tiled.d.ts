...
declare module tiled {
    class TMXTilemap extends egret.Sprite {
        ...
        private _renderRectX;//mwt
        private _renderRectY;//mwt
        /**
         * 创建1个TMXTilemap实例对象
         * @param renderRectX 渲染区域裁剪坐标X
         * @param renderRectY 渲染区域裁剪坐标Y
         ...
         * @version egret 3.0.3
         */
        constructor(renderRectX: number, renderRectY: number,renderwidth: number, renderheight: number, data: any, url: string);
